...
````
Expectation = B / A where B is variable and A is constant for given links. Expectation is higher if B is high and low if B is low. B = bert vector. A=atomic vector.
````
